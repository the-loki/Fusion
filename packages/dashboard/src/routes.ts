...
import { registerTaskRoutes } from "./routes/register-tasks.js";
import { registerPlanningChatRoutes } from "./routes/register-planning-chat.js";
import { registerSettingsMemoryRoutes } from "./routes/register-settings-memory.js";
...
export function createApiRoutes(store: TaskStore, options?: ServerOptions): Router {
  ...
  registerPlanningChatRoutes(routeContext);
